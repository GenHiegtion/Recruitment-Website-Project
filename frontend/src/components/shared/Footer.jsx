const Footer = () => {
    return (        
        <footer className="border-t border-t-gray-200 py-8 px-10">
            <div className="container mx-auto px-4 max-w-full md:max-w-none md:px-12">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <h2 className="text-xl font-bold text-[#14AE5C]">Job Hunter</h2>
